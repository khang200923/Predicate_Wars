...
res = game.calcStatement(pd.Statement.lex('[potency]($player:0$)', special=True), obj=True, calcInstance=inst)
test('PWars.calcStatement 1', res == pd.Statement.lex(str(game.players[0].potency)), str(res))
res = game.calcStatement(pd.Statement.lex('(1 + ((3 * 4) - 2))'), obj=True, calcInstance=inst)
test('PWars.calcStatement 2', res == pd.Statement.lex(str(11)), str(res))
res = game.calcStatement(pd.Statement.lex('((1 + ((3 * 4) - 2)) = 11)'), obj=False, calcInstance=inst)
test('PWars.calcStatement 3', res == pd.Statement.lex('tT'), str(res))
res = game.calcStatement(pd.Statement.lex('((1 + ((3 * 4) - 2)) = 69420)'), obj=False, calcInstance=inst)
