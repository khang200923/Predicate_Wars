...
- Existential modus ponens: If **p1** is ∃(x)(**A**(x)) and **p2** is (**A**(x) → **B**(x)) then **c** is ∃(x)(**B**(x))
- Identity: **c** is (∀(x)(x = x))
